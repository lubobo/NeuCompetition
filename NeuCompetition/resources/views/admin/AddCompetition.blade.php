...
@section('content')
    <div  style="margin-top:25px;">
        <div class="col-xs-12 row">
            {{--<div class="panel-default"><h3 class=" text-center text-warning">竞赛发布管理系统</h3></div>--}}
            @if($errors->any())
            ...
            @endif
            <form class="form-group" action="{{route('PostCompetition')}}" method="POST" style="width:60%" enctype="multipart/form-data">
                <div class="col-xs-3 col-xs-offset-0">
                    <div><span class="text-success">竞赛名称：</span>
                        <input class="form-control" name="com_name"  onmouseout="checkName(this.value)" type="text" placeholder="竞赛名称">
                    ...
                    <div><span class="text-success">竞赛人数：</span>
                        <input class="form-control" name="student_num" onmouseout="checkNum(this.value)" type="text" placeholder="竞赛人数">
                        <h5 class="text-danger" id="num"></h5>
                    </div>
                    <div><span class="text-success">竞赛地点：</span>
                        <input class="form-control" name="com_place" onmouseout="checkPlace(this.value)" type="text" placeholder="竞赛地点">
                    ...
                    <div><span class="text-success">赛事时间：</span>
                        <input class="form-control" name="com_time" type="date">
                    </div>
                    <div><span class="text-success">报名时段：</span>
                        <input class="form-control" name="start_time" type="date">
                        <p> </p>
                        <input class="form-control" name="end_time" type="date">
                    </div>
...
<script language="JavaScript">
    ...
    //    function status_1() {
    //        document.getElementById('status_back').style.display=inline;
    //    }
</script>